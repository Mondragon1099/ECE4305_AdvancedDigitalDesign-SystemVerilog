...
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { M[0] }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { M[1] }]; #IO_L7N_T1_D10_14 Sch=sw[5]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { M[2] }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { M[3] }]; #IO_L5N_T0_D07_14 Sch=sw[7]
...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { out_put }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
#set_property LOAD 5 [get_ports {y[0]}]
#set_property LOAD 5 [get_ports {y[1]}]
#set_property LOAD 5 [get_ports {y[2]}]
#set_property LOAD 5 [get_ports {y[3]}]
#set_property LOAD 5 [get_ports {y[4]}]
#set_property LOAD 5 [get_ports {y[5]}]
#set_property LOAD 5 [get_ports {y[6]}]
#set_property LOAD 5 [get_ports {y[7]}]
